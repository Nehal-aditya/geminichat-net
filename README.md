...
[![CI](https://img.shields.io/github/actions/workflow/status/Nehal-aditya/geminichat-net/release.yml?style=flat-square&label=build)](https://github.com/Nehal-aditya/geminichat-net/actions/workflows/release.yml)
